...
- X_BOOKMARKS: Posts the operator bookmarked on X, fetched with a browser session
...
class ContentSource(StrEnum):
    ...
    X_BOOKMARKS = "x_bookmarks"  # Posts bookmarked on X, fetched with a browser session
    OTHER = "other"
