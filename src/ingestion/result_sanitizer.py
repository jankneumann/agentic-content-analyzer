...
_SAFE_DIAGNOSTIC_MESSAGES = {
    ...
    "body_too_large": "A clip body exceeded its configured limit",
    ...
    "credentials_missing": "The source credential is not configured",
    "directory_unavailable": "A configured source directory is unavailable",
    ...
    "file_unavailable": "A source file is unavailable",
    "file_unstable": "A source file changed during scanning",
    "file_ingest_error": "A file could not be ingested",
    "file_not_found": "A requested file was not found",
    "frontmatter_not_mapping": "Clip metadata must be a mapping",
    "frontmatter_too_large": "Clip metadata exceeded its configured limit",
    "generated_content": "Generated content was skipped",
    "invalid_capture_client": "The clip capture client is unsupported",
    "invalid_captured_at": "The clip capture timestamp is invalid",
    "invalid_content_type_hint": "The clip content type is unsupported",
    "invalid_cursor": "The scan cursor is invalid",
    "invalid_encoding": "A clip has invalid text encoding",
    "invalid_frontmatter": "Clip metadata is invalid",
    "invalid_url": "The clip source URL is invalid",
    ...
    "normalization_collision": "A normalized source entry was skipped",
    "note_too_large": "A clip exceeded its configured size limit",
    "oauth_unavailable": "Source authorization is unavailable",
    "page_cap_reached": "The run reached its page limit; older items were not read",
    ...
    "rate_limited": "The source rate-limited the run; older items were not read",
    "retry_exhausted": "The source item exhausted its retry budget",
    "scan_byte_limit": "The scan byte limit was reached",
    "scan_depth_limit": "The scan depth limit was reached",
    "scan_duration_limit": "The scan duration limit was reached",
    "scan_entry_limit": "The scan entry limit was reached",
    "scan_file_limit": "The scan file limit was reached",
    ...
    "session_expired": "The source session was rejected; refresh the browser session",
    ...
    "unsafe_path": "A source entry failed path safety validation",
    "video_processing_error": "A video could not be processed",
    "yaml_alias_limit": "Clip metadata exceeded its alias limit",
    "yaml_custom_tag": "Clip metadata contains an unsupported tag",
    "yaml_depth_limit": "Clip metadata exceeded its depth limit",
    "yaml_duplicate_key": "Clip metadata contains a duplicate key",
    "yaml_invalid": "Clip metadata is invalid",
    "yaml_node_limit": "Clip metadata exceeded its node limit",
    "yaml_string_limit": "Clip metadata exceeded its string limit",
    "yaml_unsupported_type": "Clip metadata contains an unsupported value",
