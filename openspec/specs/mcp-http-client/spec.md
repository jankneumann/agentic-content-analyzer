...
MCP tool transport behavior for routing selected tools through the ACA HTTP API when configured, while preserving in-process fallback semantics and OpenAPI-aligned response shapes.
