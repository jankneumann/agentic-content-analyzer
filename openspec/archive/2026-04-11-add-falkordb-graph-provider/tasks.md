...
- [x]1.1 Write tests for GraphDBProvider protocol and Neo4j implementation
...
- [x]1.2 Write tests for GraphitiClient async factory and graceful degradation
...
- [x]1.3 Upgrade graphiti-core to >=0.28.0 in pyproject.toml
...
- [x]1.4 Create GraphDBProvider protocol and Neo4jGraphDBProvider in `src/storage/graph_provider.py`
...
- [x]1.5 Refactor GraphitiClient to use async factory + provider
...
- [x]1.6 Add graphdb_provider/graphdb_mode settings + profile flattening + deprecated aliases
...
- [x]1.7 Update ReferenceGraphSync to use provider
...
- [x]1.8 Write tests for ReferenceGraphSync with provider (Neo4j)
...
- [x]1.9 Update connection_checker.py and manage_commands.py for provider
...
- [x]1.10 Verify all existing tests pass after graphiti-core upgrade
...
- [x]2.1 Write tests for FalkorDBGraphDBProvider (unit tests with mocks)
...
- [x]2.2 Create FalkorDBGraphDBProvider in `src/storage/falkordb_provider.py`
...
- [x]2.3 Add FalkorDB Docker service
...
- [x]2.4 Create FalkorDB Lite test fixture with orphan cleanup
...
- [x]2.5 Write provider-level integration tests on FalkorDB
...
- [x]2.6 Write ReferenceGraphSync integration test on FalkorDB
...
- [x]2.7 Update profile YAML files for new graphdb provider model
...
- [x]3.1 Write tests for file-level export/import on provider
...
- [x]3.2 Rename data models in src/sync/models.py
...
- [x]3.3 Implement export_graph/import_graph on Neo4jGraphDBProvider
...
- [x]3.4 Implement export_graph/import_graph on FalkorDBGraphDBProvider
...
- [x]3.5 Update sync CLI commands to use provider
...
- [x]3.6 Write cross-backend round-trip integration test
...
- [x]4.1 Update graph CLI commands for provider transparency
...
- [x]4.2 Update CLI adapters for async factory
...
- [x]4.3 Update theme_analyzer and historical_context with graceful degradation
...
- [x]4.4 Update agent memory GraphStrategy
...
- [x]4.5 Add Makefile targets for FalkorDB
