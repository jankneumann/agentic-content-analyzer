...
| obsidian-vault-ingest.2 | `specs/obsidian-vault-ingest/spec.md` | Strict bounded clip metadata contract | --- | D5 | --- | parser valid/default/invalid/adversarial YAML tests | --- |
...
| obsidian-vault-ingest.4 | `specs/obsidian-vault-ingest/spec.md` | Deterministic inert Markdown normalization | --- | D5, D6 | --- | normalization goldens and renderer regression tests | --- |
...
| obsidian-vault-ingest.6 | `specs/obsidian-vault-ingest/spec.md` | Canonical identity preserves note context | --- | D5, D8 | --- | URL canonicalization and duplicate annotation integration tests | --- |
