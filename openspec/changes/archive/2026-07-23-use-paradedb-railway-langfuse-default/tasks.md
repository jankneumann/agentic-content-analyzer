...
- [x] 1.1 Write profile loading tests for Langfuse defaults
...
- [x] 1.2 Update `profiles/base.yaml` — change observability default to `langfuse`
...
- [x] 1.3 Update `profiles/local.yaml` — add self-hosted Langfuse config
...
- [x] 1.4 Update `profiles/railway.yaml` — switch to Langfuse Cloud
...
- [x] 1.5 Update `profiles/railway-neon.yaml` — switch to Langfuse Cloud
...
- [x] 1.6 Update `profiles/staging.yaml` — switch to Langfuse Cloud with staging isolation
...
- [x] 1.7 Update `profiles/railway-neon-staging.yaml` — switch to Langfuse Cloud
...
- [x] 1.8 Update `profiles/supabase-cloud.yaml` — switch to Langfuse Cloud
...
- [x] 1.9 Verify `.secrets.yaml` template has Langfuse credential placeholders
  **Dependencies**: 1.2
...
- [x] 1.10 Update Makefile comments for default Langfuse dev experience
  **Dependencies**: 1.3
  **Files**: `Makefile`
  **Details**:
...
- [x] 2.1 MANUAL: Build and publish ParadeDB image to GHCR
...
- [x] 2.3 Add ParadeDB GHCR image comments to Railway profile
  **Spec scenarios**: profile-configuration — Railway profile documents ParadeDB GHCR image
  **Dependencies**: 2.1
  **Files**: `profiles/railway.yaml`
  **Details**:
...
- [x] 3.1 Run full profile validation
  **Dependencies**: 2.3
...
- [x] 3.2 Add deprecation comment to `local-langfuse.yaml`
  **Dependencies**: 1.3
