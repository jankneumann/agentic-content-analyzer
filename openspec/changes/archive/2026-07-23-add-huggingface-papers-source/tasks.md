...
- [x] 4.1 Add MCP tool for agent invocation
  **Spec scenarios**: hf-papers.14
  **Design decisions**: D5
  **Files**: `src/mcp_server.py` (modified)
  **Dependencies**: 2.4

- [x] 4.2 Add queue worker dispatch entry for HTTP API path
  **Spec scenarios**: hf-papers.15
  **Design decisions**: D5
  **Files**: `src/queue/worker.py` (modified)
  **Dependencies**: 2.4

- [x] 4.3 Update API docstring to document huggingface_papers source
  **Spec scenarios**: hf-papers.15
  **Files**: `src/api/content_routes.py` (modified)
  **Dependencies**: none

- [x] 4.4 Add frontend ingest UI support
