...
- [x] 1.1 Add production startup validation and environment-aware CORS defaults.
...
- [x] 1.2 Define explicit public endpoint allowlist (documentation constant).
...
## 2. Upload Hardening
- [x] 2.1 Add file signature (magic bytes) validation for uploads.
  ...
  - Dependencies: none (independent)
- [x] 2.2 Add MIME type cross-check for uploads.
...
## 3. Testing
- [x] 3.1 Add tests for production startup validation and CORS defaults (1.1).
  ...
  - Dependencies: 1.1
- [x] 3.2 Add tests for file signature and MIME validation (2.1, 2.2).
...
## 4. Documentation
- [x] 4.1 Document production security configuration requirements.
