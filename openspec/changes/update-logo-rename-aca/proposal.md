...
The source logo image is available at `web/public/icons/rotkohl-logo-source.png`. All icon variants should be generated from this source file.

## What Changes

- Replace the current "N" letter logo (icon.svg and all PNG variants) with the new purple circuit-brain tree logo from `rotkohl-logo-source.png`
