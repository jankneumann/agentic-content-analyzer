...
export interface OperationContextEnvelope {
  ...
  claim_generation: number; attempt_number: number | null; entrypoint: string; service_name: string;
...
export interface OperationAttemptSummary {
  claim_generation: number; attempt_number: number; trace_id: string; root_span_id: string;
...
export interface OperationAttemptPage {
  ...
  attempts_omitted: number; next_after_claim_generation: number | null;
}
...
export interface ObservabilityHealthPage {
  ...
  processes: ProcessObservabilityHealth[];
}
