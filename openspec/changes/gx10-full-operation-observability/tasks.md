...
- [ ] 2.1 [S] Write failing migration and repository tests for nullable legacy rows, lossless signed-BIGINT boundary IDs/generations including max/max+1/generation-plus-one overflow and duplicate-context mismatch rejection, diagnostic type/byte constraints, exact trace lookup, attempt ordering, retention-safe root deletion, process-health freshness/restart-churn cleanup, submission-context unknown-key rejection, audit/terminal correlation, and failure-biased cleanup. References: CORR-007, CORR-008, CORR-017, JOB-001, JOB-002, JOB-003, contracts/sql/001_operation_observability.sql, D3, D9.
