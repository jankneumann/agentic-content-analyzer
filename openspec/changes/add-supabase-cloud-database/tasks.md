...
## 1. Create Database Provider Abstraction
...
- [ ] 2.1 Add Supabase settings to `src/config/settings.py`:
...
- [ ] 2.2 Add `database_provider` computed property for auto-detection
- [ ] 2.3 Add `get_database_url()` method to construct URLs from Supabase config
...
- [ ] 3.3 Add connection health check for Supabase connections
...
- [ ] 4.4 Update `docs/ARCHITECTURE.md` with provider abstraction diagram
...
- [ ] 5.5 Add health check endpoint test for database connectivity

## 6. Validation

- [ ] 6.1 Test local PostgreSQL still works (regression)
- [ ] 6.2 Test Supabase free tier connection
- [ ] 6.3 Verify Alembic migrations work with Supabase
