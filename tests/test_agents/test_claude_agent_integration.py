...
from src.config.models import ModelConfig, Provider, ProviderConfig, MODEL_REGISTRY
...
def test_summarize_newsletter_success(mock_anthropic, test_model_config, sample_newsletter, mock_anthropic_response):
    ...
    assert response.data.executive_summary == "Major AI advancements this week including new LLM releases."
...
@patch("src.agents.claude.summarizer.Anthropic")
def test_summarize_newsletter_json_parse_error(mock_anthropic, test_model_config, sample_newsletter):
...
@patch("src.agents.claude.summarizer.Anthropic")
def test_summarize_newsletter_with_specific_model(mock_anthropic, test_model_config, sample_newsletter, mock_anthropic_response):
...
@patch("src.agents.claude.summarizer.Anthropic")
def test_summarize_newsletter_retry_mechanism(mock_anthropic, test_model_config, sample_newsletter, mock_anthropic_response):
...
@patch("src.agents.claude.summarizer.Anthropic")
def test_summarize_newsletter_with_feedback(mock_anthropic, test_model_config, sample_newsletter, mock_anthropic_response):
